          ...
          content: [
            {
              type: "input_text",
              text:
                'Extract only the total amount and currency from this receipt image. Return strict JSON with keys: amount_minor (integer or null), currency (3-letter ISO code or null), confidence (0-1).'
            },
            {
              type: "input_image",
              image_url: dataUrl
